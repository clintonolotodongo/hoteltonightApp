...
<head>
  ...
  <body>
    ...
    <div class="hero-block-wrapper bg-primary">
      ...
      <div class="container">                   
        <!-- Skip Page-->
        <div class="skip-page"><a href="page-home.php">Skip</a></div>
        <!-- Hero Block Content-->
        <div class="hero-block-content"><img class="mb-4" src="img/bg-img/19.png" alt="">
          <h4 class="display-4 text-white mb-3"><b>Get the Latest Updates about where to spend your weekend</b><br></h4>
          <p class="text-white">WhereTONIGHT APP UGANDA </p><a class="btn btn-warning btn-lg w-100" href="page-login.php">Get Started</a>
        </div>
      </div>
    </div>
