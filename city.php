    ...
    <div class="page-content-wrapper">
      ...
      <div class="top-products-area product-list-wrap">
        <div class="container">
          ...
          <div class="col-md-4">
            <p>please select the district where you would like to spend the weekend.</p>
          <form action="city.php" method="POST">
              ...
              <select name="city" class="form-control">
                ...
                <option value="Fort_portal">Fort portal</option>
                <option value="Masindi">Masindi</option>
               
               </select>
              </div>
               <div class="btn-group">
               <input type="submit" name="submit" class="btn btn-sm btn-primary" value="LET'S GO">
               </div>
          </form>
          <br><br>
          <?php
            $conn = mysqli_connect("localhost","root","","wheretonight") or die("can not connect to the database");
            if(isset($_POST['submit'])){

              $cityinfo = $_POST['city'];


              $hotel = mysqli_query($conn,"SELECT * FROM hotel WHERE hotel_address  LIKE '%$cityinfo%'") or die(mysqli_error($conn));
              while($prow = mysqli_fetch_array($hotel)){
                echo '<div class="card single-product-card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="card-side-img">
                    
                      <!-- Product Thumbnail--><a href="entertainment_details.php?hotel_id='.$prow['hotel_id'].'"><img class="product-thumbnail d-block" align="center" src="hotelimg/'.$prow["hotel_photo"].'" style="width:700px;height:100hv;padding:5px;"></a>
                    </div>
                    <div class="card-content px-4 py-2">
                      <!-- Product Title--><a class="product-title d-block text-truncate mt-0" href="page-shop-details.html">'.$prow['hotel_name'].'</a>
                      <!-- Product Price-->
                      <!--p class="sale-price">'.$prow['hotel_address'].'</p><a class="btn btn-danger btn-sm disabled" href="#">'.$prow['hotel_name'].'</a-->
                      <!--p class="btn btn-primary">'.$prow['hotel_desc'].'</p-->
                      <p class="btn btn-success">Views '.$prow['view'].'</p>
                      <a href="gmap.php?hotel_id='.$prow['hotel_id'].'"><img src="gmaps/googlemaps.JPG" style="width:50px;"></a>
                    </div>
                  </div>
                </div>
              </div>';
