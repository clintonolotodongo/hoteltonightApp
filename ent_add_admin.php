...
<path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/>
	...
	if(isset($_POST['addent'])){
      ...
      $ent_name = mysqli_real_escape_string($conn,$_POST['ent_name']);
      $entry_cost = mysqli_real_escape_string($conn,$_POST['entry_cost']);
      ...
      if(!empty($filename)){
		...
		$sql = mysqli_query($conn,"INSERT INTO entertainment(hostel_id,entertainment_name,entry_cost,entertainment_pic) VALUES ('$hotel_id','$ent_name', '$entry_cost', '$filename')") or die(mysqli_error($conn));
		if($sql){
			echo"
            
            <div class='alert alert-success'>Entertainment  posted</div>
            ";
		}
		else{
		...
		echo"
    <div class='alert alert-danger'>No Entertainment Added Yet, Fill the form</div>
    ";
	}
...
<path fill-rule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
          ...
          <div class="heading-text">
            <h5 class="mb-0">Add Entertainment </h5><span>please provide the following entertainment information. &amp; .</ter amp; span>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <label for="">Entertainment Name</label>
                    <select name="ent_name" class="form-control" id="">
                        <option value="Comedy">Comedy</option>
                        <option value="Show">Music Show</option>

                    </select>
                  </div>
                    <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="Entry Cost"  name="entry_cost" required>
                  </div>
          ...
          <div class="form-group" >
            ...
            <input type="submit" value="ADD ENTERTAINMENT" name="addent" style=" background-color: #516BEB; /* Green */
border: none;
color: white;
padding: 15px 32px;
text-align: center;
...
font-size: 16px;" value="Add product">
            ...
            <a href="entertainment.php" style=" background-color: orange; /* Green */
border: none;
color: white;
padding: 15px 32px;
text-align: center;
...
<path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>
          ...
          <div class="heading-text" style="display:none;">
            <h5 class="mb-0">Add Events</h5><span>Add Events for a particular hotel that will be viewed by customers.</span>
          </div>
        </div>
        <div class="card">
          <div class="card-body"style="display:none;">
            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea type="text" placeholder="Program Description" class="form-control" name="description"></textarea>
                  </div>
              </div>
