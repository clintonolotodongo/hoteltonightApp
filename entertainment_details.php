...
if(isset($_GET['hotel_id'])){
   ...
   // echo "<script>alert('$hotel_id');</script>";
}else{
      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">Hotel Events List</h6>
          </div>
          <!-- Navbar Toggler-->
    ...
    <div class="page-content-wrapper py-3">
      ...
      <div class="top-products-area product-list-wrap">
        <div class="container">
          ...
          <?php
                      include 'conn.php';
                        $sql = mysqli_query($conn,"SELECT entertainment_pic,entertainment_name,entry_cost,date_created FROM entertainment WHERE hostel_id = $hotel_id");
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="card-side-img">
                      ...
                      <!-- Product Thumbnail--><a class="product-thumbnail d-block" href="#"><img src="hotelimg/'.$prow['entertainment_pic'].'" alt="">
                        <!-- Badge--><span class="badge bg-primary"></span></a>
                    </div>
                    <div class="card-content px-4 py-2">
                      <!-- Product Title--><a class="product-title d-block text-truncate mt-0" href="page-shop-details.html">'.$prow['entertainment_name'].'</a>
                      <!-- Product Price-->
                      <p class="sale-price">UGX '.$prow['entry_cost'].'</p><a class="btn btn-danger btn-sm disabled" href="#">available</a>
