    ...
    <div class="page-content-wrapper">
      ...
      <div class="top-products-area product-list-wrap">
        <div class="container">
          ...
          <?php
                      include 'conn.php';
                      $sql = mysqli_query($conn,"SELECT * FROM hotel where hotel_id = '$hotel_id'");
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="card-side-img">
                      ...
                      <!-- Product Thumbnail--><a href="hotel_products.php?hotel_id='.$prow['hotel_id'].'"><img class=""  src="gmaps/'.$prow["Gmap"].'" style="width:100%;"></a>
                    </div>
