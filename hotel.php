    ...
    <div class="page-content-wrapper">
      ...
      <div class="top-products-area product-list-wrap">
        <div class="container">
          ...
          <?php
                      include 'conn.php';
                      $sql = mysqli_query($conn,"SELECT DISTINCT h.hotel_name,h.hotel_address,h.hotel_phone,h.hotel_photo,h.hotel_desc,h.hotel_email,h.view, p.product_name,p.hotel_id FROM hotel h LEFT JOIN products p ON h.hotel_id= p.hotel_id GROUP BY h.hotel_id ");
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="card-side-img">
                      ...
                      <!-- Product Thumbnail--><a href="hotel_products.php?hotel_id='.$prow['hotel_id'].'"><img class="product-thumbnail d-block" align="center" src="hotelimg/'.$prow["hotel_photo"].'" style="width:700px;height:100hv;padding:5px;"></a>
                    </div>
                    <div class="card-content px-4 py-2">
                      <!-- Product Title--><a class="product-title d-block text-truncate mt-0" href="page-shop-details.html">'.$prow['hotel_name'].'</a>
                      <!-- Product Price-->
                      <p class="sale-price">'.$prow['hotel_address'].'</p><a class="btn btn-danger btn-sm disabled" href="#">'.$prow['hotel_phone'].'</a>
