...
$cusrec= mysqli_query($conn,"SELECT * FROM customers WHERE customer_id = '$id'");
$rec = mysqli_fetch_array($cusrec);
$username = $rec['customer_name'];
$tel = $rec['customer_tel'];
$gender = $rec['gender'];
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card bg-primary mb-3 shadow-sm bg-gradient direction-rtl">
              <div class="card-body">
                <h2 class="text-white">Welcome <?php echo $username;?></h2>
