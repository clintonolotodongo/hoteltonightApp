  ...
  <body>
    ...
    <div class="sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        ...
        <!-- User Thumbnail-->
        <div class="user-profile"><img src="img/icons/ACoding.png" alt=""></div>
        <!-- User Info-->
        <div class="user-info">
          ...
          <div class="card-body">
            <form action="#">
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control" id="fullname" type="text" value="AC" placeholder="Full Name" readonly>
              </div>
              <div class="form-group mb-3">
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control" id="portfolio" type="url" value="www.youtube.com/animationcoding" placeholder="Portfolio URL">
              </div>
              <div class="form-group mb-3">
