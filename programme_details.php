    ...
    <div class="page-content-wrapper py-3">
      ...
      <div class="top-products-area product-list-wrap">
        <div class="container">
          ...
          <?php
                      include 'conn.php';
                        $sql = mysqli_query($conn,"SELECT * FROM programmes WHERE hotel_id = '$hotel_id'");
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="card-side-img">
                      ...
                      <!-- Product Thumbnail--><a class="product-thumbnail d-block" href="page-shop-details.html"><img src="prodimg/'.$prow['programme_pic'].'" alt="">
                    ...
                    <div class="card-content px-4 py-2">
                      ...
                      <!-- Product Price-->
                      <p class="sale-price">UGX '.$prow['programme_desc'].'</p><a class="btn btn-danger btn-sm disabled" href="#">available</a>
                    </div>
                  </div>
                </div>
              </div>
